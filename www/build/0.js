...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__orders_history__ = __webpack_require__(852);
...
var OrdersHistoryPageModule = (function () {
    ...
    OrdersHistoryPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__orders_history__["a" /* OrdersHistoryPage */]),
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(828)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(705);
...
var OrdersHistoryPage = (function () {
    ...
    OrdersHistoryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\Users\slamonega\Documents\App Economia Social\giraffy-delivery-complete-food-delivery-platform-with-mobile-apps\application\src\pages\personal\orders_history\orders_history.html"*/'<ion-header>\n\n    <ion-navbar custom-navbar>\n\n        <button ion-button menuToggle *ngIf="loggedIn">\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n        <ion-title>\n\n            {{ \'order.history\' | translate }}\n\n        </ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-card *ngFor="let order of orders" (click)="showOrder(order)">\n\n        <ion-item>\n\n            <h2 [translate]="\'order.id\'" [translateParams]="{ id: order.id }"></h2>\n\n            <p>{{ order.address }}</p>\n\n            <p>{{ stringAsDate(order.created_at) | date: date_format }}</p>\n\n        </ion-item>\n\n        <ion-item>\n\n            <p *ngIf="order.restaurant && multiR">\n\n                {{ order.restaurant.name }}\n\n            </p>\n\n            <p><b>{{ order.total_with_tax | ecurrency }}</b></p>\n\n        </ion-item>\n\n    </ion-card>\n\n</ion-content>'/*ion-inline-end:"C:\Users\slamonega\Documents\App Economia Social\giraffy-delivery-complete-food-delivery-platform-with-mobile-apps\application\src\pages\personal\orders_history\orders_history.html"*/
        }),
